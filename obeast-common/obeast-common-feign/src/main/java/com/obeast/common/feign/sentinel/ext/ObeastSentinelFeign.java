 ...
 */
public final class ObeastSentinelFeign {

	private ObeastSentinelFeign() {
			...
			super.invocationHandlerFactory(new InvocationHandlerFactory() {
				...
				public InvocationHandler create(Target target, Map<Method, MethodHandler> dispatch) {
					...
					if (void.class != fallback) {
						...
						return new ObeastSentinelInvocationHandler(target, dispatch,
					...
					if (void.class != fallbackFactory) {
						...
						return new ObeastSentinelInvocationHandler(target, dispatch, fallbackFactoryInstance);
					}
					return new ObeastSentinelInvocationHandler(target, dispatch);
				}
