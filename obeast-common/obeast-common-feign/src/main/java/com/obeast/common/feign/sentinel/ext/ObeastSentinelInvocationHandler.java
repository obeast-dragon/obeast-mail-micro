package com.obeast.common.feign.sentinel.ext;
...
import com.obeast.common.feign.annotation.FeignRetry;
import feign.Feign;
 ...
 */
@Slf4j
public class ObeastSentinelInvocationHandler implements InvocationHandler {
	...
	ObeastSentinelInvocationHandler(Target<?> target, Map<Method, InvocationHandlerFactory.MethodHandler> dispatch,
			...
			if (methodMetadata == null) {
				...
				try {
					...
					if (fallbackFactory != null) {
						...
						if (CommonResult.class == method.getReturnType() && Objects.isNull(feignRetry)) {
							log.error("feign 服务间调用异常", ex);
							return CommonResult.error(ex.getLocalizedMessage());
						}
						else {
							throw ex;
						}
	...
	public boolean equals(Object obj) {
		if (obj instanceof SentinelInvocationHandler) {
			ObeastSentinelInvocationHandler other = (ObeastSentinelInvocationHandler) obj;
