...
public class ObeastResourceServerAutoConfiguration {
	 ...
	 */
	@Bean
	public ObeastBearerTokenExtractor pigBearerTokenExtractor(PermitAllUrlProperties urlProperties) {
		return new ObeastBearerTokenExtractor(urlProperties);
	}
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector(OAuth2AuthorizationService authorizationService) {
		return new ObeastCustomOpaqueTokenIntrospector(authorizationService);
	}
	...
	public RequestInterceptor oauthRequestInterceptor(BearerTokenResolver tokenResolver) {
		return new ObeastOAuthRequestInterceptor(tokenResolver);
	}
