 ...
 * Date 2023/4/9 23:48
 * @version 1.0
 * Description: ObeastDaoAuthenticationProvider
 */
public class ObeastDaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	public ObeastDaoAuthenticationProvider() {
