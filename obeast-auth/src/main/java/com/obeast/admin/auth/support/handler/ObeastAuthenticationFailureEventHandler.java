 ...
 */
@Slf4j
public class ObeastAuthenticationFailureEventHandler implements AuthenticationFailureHandler {
	...
	private void sendErrorResponse(HttpServletRequest request, HttpServletResponse response,
		...
		this.errorHttpResponseConverter.write(CommonResult.error(errorMessage), MediaType.APPLICATION_JSON, httpResponse);
	}
