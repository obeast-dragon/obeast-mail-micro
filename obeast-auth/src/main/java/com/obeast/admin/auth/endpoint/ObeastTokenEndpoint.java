package com.obeast.admin.auth.endpoint;
...
import com.obeast.admin.api.feign.RemoteClientDetailsService;
import com.obeast.admin.api.vo.TokenVo;
...
import com.obeast.common.security.util.OAuth2EndpointUtils;
import com.obeast.common.security.util.OAuth2ErrorCodesExpand;
import com.obeast.common.security.util.OAuthClientException;
...
public class ObeastTokenEndpoint {

	private final HttpMessageConverter<OAuth2AccessTokenResponse> accessTokenHttpResponseConverter = new OAuth2AccessTokenResponseHttpMessageConverter();

	private final AuthenticationFailureHandler authenticationFailureHandler = new ObeastAuthenticationFailureEventHandler();
	...
	public ModelAndView confirm(Principal principal, ModelAndView modelAndView,
		...
		SysOauthClientDetails clientDetails = Optional.of(clientDetailsService.getClientDetailsById(clientId).getData())
	...
	public CommonResult<Boolean> removeToken(@PathVariable("token") String token) {
		...
		// 处理自定义退出事件，保存相关日志
		SpringBeanUtil.publishEvent(new LogoutSuccessEvent(new PreAuthenticatedAuthenticationToken(
	...
	@Inner
	@GetMapping("/page")
	public CommonResult<Page<TokenVo>> tokenList(
