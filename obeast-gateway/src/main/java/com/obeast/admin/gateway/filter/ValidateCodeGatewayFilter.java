package com.obeast.admin.gateway.filter;
...
import com.obeast.admin.gateway.config.GatewayConfigProperties;
import com.obeast.common.core.base.CommonResult;
import com.obeast.common.core.constant.CacheConstants;
import com.obeast.common.core.constant.SecurityConstants;
import com.obeast.common.core.exception.ValidateCodeException;
 ...
 * Date 2023/4/10 0:12
 * @version 1.0
 * Description: 验证码处理 The type Validate code gateway filter.
 */
@Slf4j
		...
		return (exchange, chain) -> {
			...
			try {
				...
				return response.writeWith(Mono.create(monoSink -> {
					try {
						byte[] bytes = objectMapper.writeValueAsBytes(CommonResult.error(errMsg));
