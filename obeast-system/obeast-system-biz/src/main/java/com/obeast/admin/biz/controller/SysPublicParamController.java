...
public class SysPublicParamController {
	...
	public CommonResult<?> publicKey(@PathVariable("publicKey") String publicKey) {
		return CommonResult.success(sysPublicParamService.getSysPublicParamKeyToValue(publicKey));
	}
	...
	public CommonResult<?> getSysPublicParamPage(Page page, SysPublicParam sysPublicParam) {
		return CommonResult.success(sysPublicParamService.page(page,
	...
	public CommonResult<?> getById(@PathVariable("publicId") Long publicId) {
		return CommonResult.success(sysPublicParamService.getById(publicId));
	}
	...
	public CommonResult<?> save(@RequestBody SysPublicParam sysPublicParam) {
		return CommonResult.success(sysPublicParamService.save(sysPublicParam));
	}
